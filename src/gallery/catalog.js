...
export const GALLERY = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'addresses', title: 'تحديد موقع التوصيل (موقع واحد لكل حساب)', code: 'CUS-011', screen: 'addresses', figma: '11:743', note: 'موقع واحد قابل للتحديث يدوياً أو من الخريطة' },
      { key: 'addresses-change', title: 'تغيير / تحديث موقع التوصيل', code: 'CUS-040', screen: 'addresses', stack: ['home'], figma: '13:3623' },
    ],
  },
  {
    id: 'customer',
    ...
    items: [
      ...
      { key: 'filters', title: 'الفلترة والترتيب الذكي — مدمجة داخل البحث', code: 'CUS-025', screen: 'search', params: { q: '', filters: true }, figma: '11:1894', note: 'الفلترة (تصنيف/سعر/متوفر) والترتيب في نفس شاشة البحث' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'cart-updated', title: 'سلة المشتريات — تنبيه «تم تحديث السلة» (Toast من الأسفل)', code: 'CUS-028', screen: 'cart', params: { demoToast: 'تم تحديث السلة بنجاح' }, state: { cart: SAMPLE_CART }, stack: ['home'], note: 'الكوبونات موقوفة مؤقتاً — الرسالة تظهر أسفل الشاشة فوق شريط التنقّل', figma: '11:2221' },
      { key: 'cart-empty', title: 'سلة المشتريات فارغة', code: 'CUS-027', screen: 'cart', state: { cart: {} }, stack: ['home'], figma: '11:2094' },
      { key: 'checkout', title: 'إتمام الطلب والدفع — بيانات التواصل والاستلام', screen: 'checkout', state: { cart: SAMPLE_CART }, stack: ['home', 'cart'], figma: '11:2175', note: 'اسم المستلم والجوال وتفاصيل العنوان مطلوبة قبل التأكيد' },
  ...
  },
  {
    id: 'account',
    title: 'الحساب',
    desc: 'الملف الشخصي (عميل/تاجر/زائر)، الصفحات القانونية، الدعم، بوابة الإدارة',
    items: [
      { key: 'account', title: 'الملف الشخصي وإدارة الحساب', screen: 'account', figma: '13:3816' },
      { key: 'account-guest', title: 'الملف الشخصي — غير مسجّل (بعد تسجيل الخروج)', screen: 'account', state: { auth: AUTH_GUEST, merchantStatus: 'none', favorites: new Set() }, figma: '13:3816' },
      ...
      { key: 'account-merchant-banned', title: 'الملف الشخصي — المتجر محظور (بطاقة تنبيه)', screen: 'account', state: { auth: AUTH_MERCHANT, merchantStatus: 'banned' }, note: 'جديد — تقود إلى شاشة الحظر', figma: '—' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'm-banned', title: 'المتجر محظور — سبب الحظر + اعتراض للإدارة + تسجيل الخروج', screen: 'merchantBanned', state: { auth: AUTH_MERCHANT, merchantStatus: 'banned' }, note: 'جديد (غير موجود في Figma) — أي شاشة m-* أثناء الحظر تُستبدل بهذه الشاشة', figma: '—' },
    ],
  },
  {
    id: 'merchant',
    ...
    items: [
      ...
      { key: 'm-store-edit', title: 'إدارة وتعديل بيانات المتجر — بعد التوثيق (الاسم والنشاط مقفلان)', state: MERCHANT_STATE, screen: 'm-store-edit', stack: ['m-dashboard'], figma: '13:4576' },
      { key: 'm-store-edit-unverified', title: 'تعديل بيانات المتجر — قبل التوثيق (الاسم والنشاط قابلان للتعديل)', state: { auth: AUTH_MERCHANT, merchantStatus: 'pending' }, screen: 'm-store-edit', stack: ['account'], note: 'قبل اعتماد المتجر لا يوجد قفل على الاسم/النشاط' },
      { key: 'm-dashboard-closed', title: 'لوحة التاجر — المتجر مغلق (Toggle الحالة)', code: 'M-050', screen: 'm-dashboard', state: { ...MERCHANT_STATE, storeOpen: false }, note: 'الإغلاق يوقف استقبال الطلبات ويظهر للعملاء «مغلق حالياً»', figma: '13:4890' },
